...
const moviesData = [
  ...
  },
  {
    ...
    image: "/pic/boruto_naruto_next_generations_1.png",
    episode: "250",
  },
  {
    id: "4",
  ...
  return (
    <div className="app-container">
      <header className="header">
        <h1 className="app-title">Anonime</h1>
        <nav>
        ...
        <div className="movie-list">
          {moviesData.map((movie) => (
            ...
            >
              ...
              <p>{movie.movieName} - Episode {movie.episode}</p>
            </div>
          ))}
        </div>
      </div>
